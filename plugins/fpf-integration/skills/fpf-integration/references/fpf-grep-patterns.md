...
> Сгенерировано из FPF-Spec.md @ ailev/FPF `44dd88188a07` (2026-07-12). Полный SHA: `44dd88188a07646ef23aca32627a3f670525853f`.
...
| Паттерн | Что найдёт |
|---------|-----------|
| `U\.Holon (135)` | (паттерн навигации) |
| `U\.BoundedContext (291)` | (паттерн навигации) |
| `U\.RoleAssignment (300)` | (паттерн навигации) |
| `U\.Capability (82)` | (паттерн навигации) |
...
| `U\.Commitment (104)` | (паттерн навигации) |
| `U\.SpeechAct (47)` | (паттерн навигации) |
| `U\.Method (581)` | (паттерн навигации) |
| `U\.MethodDescription (256)` | (паттерн навигации) |
...
| `Strict Distinction (43)` | (паттерн навигации) |
...
| `Advanced Mereology (11)` | (паттерн навигации) |
| `Role-Method-Work (9)` | (паттерн навигации) |
| `U\.Work (883)` | (паттерн навигации) |
| `U\.WorkPlan (245)` | (паттерн навигации) |
| `Characteristic (1000)` | (паттерн навигации) |
...
| Паттерн | Что найдёт |
|---------|-----------|
| `U\.Episteme` | The claim-bearing, non-agentive episteme type — the core knowledge object of FPF (defined in C.2.1 'U.Episteme - Epistemes and their slot relation'; the holon root is now A.1 'Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)'). 1050 hits; navigates episteme definitions, kinds (U.EpistemeCard/View/Publication), and definitionEpistemeRef usage across the spec. |
| `U\.EpistemePublication` | The publication of an episteme as a distinct object from the episteme itself and from its carrier/projection (governed by A.10 Evidence Graph Referring and E.24.PUB). 121 hits; key for the 'a credential/badge/excerpt is only a publication, not the governing register entry' distinction and EFEM object kinds (A.6.3). |
...
| `EntityOfConcern` | The EntityOfConcern (EoC) — the entity a pattern is fundamentally about, used pervasively to fix the core boundary of each pattern (e.g. 'Core boundary: the CharacteristicSpace is the EoC here'). 2076 hits; the highest-frequency new locator for finding what any pattern centers on. Companion abbreviation 'EoC' (59) for terser scans. |
