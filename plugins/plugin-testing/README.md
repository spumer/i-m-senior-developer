...
После этих правок проверка planner прошла три кейса по три повтора при строгом
пороге — наблюдение от 22.08.2026 на Claude Code `2.1.239`, версии плагина
`1.1.1` и модели `opus`. На `sonnet` маршрутизация в проработку не наблюдалась.
Отчёт — `docs/reports/planner.md`.
