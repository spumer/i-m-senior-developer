...
Что значат «свод», «компетенция», DPF, LPF, ground/apply, затенение и протухание — словарь в README плагина `fpf-integration`, раздел «Словарь». Здесь термины не пересказываются.
