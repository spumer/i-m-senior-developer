...
пересказывает код, не ссылается на внутренние доки и не хранит историю
изменений. Нормативный текст — классы смеллов с ❌/✅, allowlist, пограничные
случаи — в `05-comment-style.md`; здесь только напоминание.
