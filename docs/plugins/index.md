...
Витрина ставится одной командой, плагины — по отдельности. Исключение — два
...
витрины `vX.Y.Z`, а его собственная версия поднимается один раз при выпуске.
...
адресу плагин добавляет шум и подрывает доверие ко всей витрине.
