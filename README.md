...
Файловый конвейер фичи: сохраняет готовую архитектуру и связанный с её версией план выполнения, не запускает реализацию по устаревшему плану, после работы обновляет каталог агентов через `/plan-reflect`.
